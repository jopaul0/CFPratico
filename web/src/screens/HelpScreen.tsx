...
const FAQ_DATA = [
    ...
    },
    {
        ...
        a: "Na tela 'Movimentação', clique com o botão direito (ou pressione e segure no mobile) em qualquer item da lista. Isso ativará o 'modo de seleção'. Clique em todas as transações que deseja apagar e, em seguida, clique no botão flutuante vermelho (que agora terá um ícone de lixeira)."
    },
    {
