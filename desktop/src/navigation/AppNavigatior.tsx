...
import { TitleBar } from '../components/TitleBar'; // 1. IMPORTAR
...
export const AppNavigator: React.FC = () => {
  ...
  return (
    // 2. MUDAR PARA flex-col
    <div className="flex flex-col h-screen bg-gray-100">
      
      {/* 3. ADICIONAR A BARRA DE TÍTULO */}
      <TitleBar />

      {/* 4. Criar um wrapper para o resto do conteúdo */}
      <div className="flex flex-1 pt-8 overflow-hidden"> 
        {/* 'pt-8' é a altura da TitleBar (h-8) para não sobrepor */}
